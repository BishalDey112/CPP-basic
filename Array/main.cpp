...
// Whenever we have to store a multiple number of  data of the same datatype then we can use array data structure to make the process easy it takes continuous memory allocation.
...
//      int num3=200;
    ...
    //how to pass a Arrays in a function
    //jab bhi array me function pass karte hai we have to 
    //make sure ki wo array ki size bhi uske saath declare kare
    ...
    // how to initialize an array with zero as a __valueles
    // int arr[5]={0};
    // int size=5;
    // PrintArray( arr,size);


    //printing with -1 as the only value just to check the output
    int arr[5]={-1};
    int size=5;
    PrintArray( arr,size);
